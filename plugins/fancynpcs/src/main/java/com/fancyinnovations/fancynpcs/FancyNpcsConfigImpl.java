...
import com.fancyinnovations.fancynpcs.api.FancyNpcsConfig;
...
public class FancyNpcsConfigImpl implements FancyNpcsConfig {
    ...
    /**
     * Whether NPCs should be saved immediately when changed.
     */
    ...
    public void reload() {
        ...
        config.setInlineComments("save_on_changed", List.of("Whether NPCs should be saved immediately when changed (create, copy, modify). If false, relies on autosave only."));
